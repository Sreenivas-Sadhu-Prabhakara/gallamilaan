// Command server runs the gallamilaan HTTP middleware.
package main
...
import (
	...
	"github.com/Sreenivas-Sadhu-Prabhakara/gallamilaan/backend"
)
...
func main() {
	...
	log.Printf("gallamilaan listening on %s", addr)
